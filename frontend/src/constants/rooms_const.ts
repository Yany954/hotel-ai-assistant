...
export const initialRooms: Room[] = [
  {
    ...
    view: "parking_lot_facing", curtainType: "manual", roomClass: "regular",
  },
  {
    ...
    view: "street_facing", curtainType: "electric", roomClass: "regular",
  },
];
 
export const CSV_TEMPLATE_HEADER =
  "roomNumber,floor,roomTypeCode,bedCount,bedType,showerType,bedClearance,isAccessible,hasKitchen,hasPullOutSofaBed,hasSofa,hasCarpet,view,curtainType,roomClass";